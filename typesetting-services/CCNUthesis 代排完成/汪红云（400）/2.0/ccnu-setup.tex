...
\ccnusetup{
  ...
  info = {
    ...
    title = {
      ...
      %
    title* = {
      Development and Application of Experimental Teaching Resources for High School Mathematics 
    }, 
      % 英文-标题
      %   适用学位类型：【本｜硕｜博】
      %
    ...
    keywords = {
      ...
      %
    keywords* = {
      High School Mathematics, Experimental Teaching, Development of Experimental Resources, GeoGebra, Seewo EasiNote
    },
      % 英文-论文关键词
      %   适用学位类型：【本｜硕｜博】
