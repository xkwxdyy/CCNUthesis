...
\ccnusetup{
  ...
  info = {
    ...
    title = {
      ...
      %
    title* = {
      Traffic Flow Prediction Based on Attention Mechanism and Graph Neural Networks
    }, 
      % 英文-标题
      %   适用学位类型：【本｜硕｜博】
      %
    ...
    keywords* = {
      ...
      Attention Mechanism,
      Adaptive Graph Network Learning
    },
      % 英文-论文关键词
      %   适用学位类型：【本｜硕｜博】
