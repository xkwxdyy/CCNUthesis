...
\ccnusetup{
  ...
  info = {
    ...
    title = {
      ...
      %
    title* = {
      The Solution and Teaching of ``Arbitrariness'' and ``Existence'' Problems of Single and Double Variable Parametric Functions
    }, 
      % 英文-标题
      %   适用学位类型：【本｜硕｜博】
      %
    ...
    degree-type* = {M.S.},
      ...
      %
    keywords = {
      任意性量词, 存在性量词, 含参函数, 教学策略, GeoGebra
    },
      % 中文-论文关键词
      %   适用学位类型：【本｜硕｜博】
      ...
      %
    keywords* = {
      Quantifiers of arbitrariness, existential quantifiers, parametric functions, teaching strategies, GeoGebra
    },
      % 英文-论文关键词
      %   适用学位类型：【本｜硕｜博】
