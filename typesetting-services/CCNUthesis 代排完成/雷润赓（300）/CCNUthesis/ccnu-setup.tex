...
\ccnusetup{
  ...
  info = {
    ...
    title = {
      ...
      %
    title* = {
      Probability Model Proofs and Methodological Exploration of Middle School Identities
    }, 
      % 英文-标题
      %   适用学位类型：【本｜硕｜博】
      %
    ...
    keywords = {
      ...
      %
    keywords* = {
      Probability Model, Secondary School Mathematics, Identity proof, Teaching Revelation.
    },
      % 英文-论文关键词
      %   适用学位类型：【本｜硕｜博】
