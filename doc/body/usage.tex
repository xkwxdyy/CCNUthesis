...
\begin{function}[updated = 2024-04-26]{style/caption-labelstyle}
...
\begin{function}[updated = 2024-04-26]{style/caption-labelseperator}
  ...
  \begin{itemize}
    ...
    \item 【本】\opt{space}：表示一个长 |1em| 的空格
    \item 【硕｜博】\opt{space}：表示「␣␣」，即两个空格
  \end{itemize}
\end{function}
