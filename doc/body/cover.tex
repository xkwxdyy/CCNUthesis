...
\begin{abstract}
  华中师范大学学位论文 \LaTeX{} 模板（非官方） \cls{CCNUthesis} 基于本科生院的论文撰写规范制作，同时参考研究生院提供的《研究生学位论文规范》，用于生成符合华中师范大学学位论文排版要求和相应的国家规范、行业标准的学位论文，旨在为同学提供毕业论文书写的方便。
\end{abstract}
...
\begin{enumerate}
  ...
  \item 请注意本模板为开发者独立开发，与学校官方部门并不存在合作关系，作者不对使用本模板产生的格式审查问题负责，请用户谨慎使用。
  \item 遇到本文档没有覆盖的问题属于正常情况，因为不同学院可能会对教务处的模板进行细节的修改，欢迎提交反馈意见。
\end{enumerate}
\end{abstract}
