...
如果确定要使用 \cls{CCNUthesis}，卸载掉 \CTeX 套装（除非你要投稿中文核心期刊），然后跟着[install-latex-guide-zh-cn](https://gitee.com/OsbertWang/install-latex-guide-zh-cn/releases) 文档正确安装 \TeXLive 。
