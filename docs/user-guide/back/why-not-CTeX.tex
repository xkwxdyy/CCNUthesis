...
先明确你要使用哪个模板，旧模板还是 \cls{CCNUthesis}，二者可以兼容，但需要处理环境变量，具体看 ljguo 的博客 \href{https://ljguo1020.github.io/2022/06/09/texlive-and-ctex/}{Windows 系统下 \TeXLive 与 \CTeX 套装共存}。
...
\subsubsection{\cls{CCNUthesis} 模板和 \CTeX 套装写的旧模板相比有什么优点}
